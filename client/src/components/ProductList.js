        ...
        <Link to={`/${product.id}`}>
         ...
         <div className="p-6">
           ...
           <div className="flex items-center flex-wrap ">
             ...
             <Link to={`/${product.id}`} className="text-gray-500 mr-3 inline-flex items-center lg:ml-auto md:ml-0 ml-auto leading-none text-lg pr-3 py-1 border-gray-800 font-bold">
               {price}
             </Link>
           </div>
         </div>
